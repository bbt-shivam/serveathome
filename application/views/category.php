...
<html lang="en">
  ...
  <?php $this->load->view('includes/nav'); ?>
        ...
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <h1 class="" data-aos="fade-up">All Categories</h1>
    ...
    <div class="site-section">
      <div class="container">
         <div class="row">
            <?php $category=$this->User_model->category(); 
              foreach($category as $cat):?>
              <div class="col-md-6 col-6 mb-4 mb-lg-3 col-lg-4">  
                <a href="<?=base_url('subcategoryPage/').$cat['cid']?>">       
                  <div class="listing-item">
                    <div class="listing-image" style="height: 180px;">
                      <img src="<?= base_url('assets/admin/img/category/')?><?=$cat['cimg']?>" alt="Image" class="img-fluid">
                    </div>
                    <div class="listing-item-content">
                      <span class="px-3 category" href="#"><?=$cat['cname']?></span>
                    </div>
                  </div>
                </a>
              </div>
