...
<head>
	...
	<!-- data tables -->
	<link href="<?=base_url('assets/admin/')?>plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css" rel="stylesheet"
		type="text/css" />
	...
	<!-- Theme Styles -->
	<link href="<?=base_url('assets/admin/')?>css/theme/light/theme_style.css" rel="stylesheet" id="rt_style_components" type="text/css" />
	<link href="<?=base_url('assets/admin/')?>css/theme/light/style.css" rel="stylesheet" type="text/css" />
	...
	<link href="<?=base_url('assets/admin/')?>css/theme/light/theme-color.css" rel="stylesheet" type="text/css" />
	<!-- favicon -->
...
<body
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img
									src="<?=base_url('assets/admin/')?>img/flags/gb.png" class="position-left" alt=""> English <span
									class="fa fa-angle-down"></span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="deutsch"><img src="<?=base_url('assets/admin/')?>img/flags/de.png" alt=""> Deutsch</a>
								</li>
								<li>
									<a class="ukrainian"><img src="<?=base_url('assets/admin/')?>img/flags/ua.png" alt=""> Українська</a>
								</li>
								<li>
									<a class="english"><img src="<?=base_url('assets/admin/')?>img/flags/gb.png" alt=""> English</a>
								</li>
								<li>
									<a class="espana"><img src="<?=base_url('assets/admin/')?>img/flags/es.png" alt=""> España</a>
								</li>
								<li>
									<a class="russian"><img src="<?=base_url('assets/admin/')?>img/flags/ru.png" alt=""> Русский</a>
								</li>
							</ul>
						</li>
						<!-- end language menu -->
								...
								<li>
									<ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url('assets/admin/')?>img/prof/prof2.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url('assets/admin/')?>img/prof/prof3.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url('assets/admin/')?>img/prof/prof1.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url('assets/admin/')?>img/prof/prof8.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url('assets/admin/')?>img/prof/prof5.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								data-close-others="true">
								<img alt="" class="img-circle " src="<?=base_url('assets/admin/')?>img/dp.jpg" />
						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="user-panel">
									<div class="pull-left image">
										<img src="<?=base_url('assets/admin/')?>img/dp.jpg" class="img-circle user-img-circle"
											alt="User Image" />
									</div>
							...
							<li class="nav-item active open">
								<a href="#" class="nav-link nav-toggle"> <i class="material-icons">face</i>
									<span class="title">Staff</span> <span class="selected"></span>
																...
																<tbody>
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std1.jpg"
																				alt="">
																		</td>
																		<td>Rajesh</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std10.jpg"
																				alt="">
																		</td>
																		<td>Pooja Patel</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std2.jpg"
																				alt="">
																		</td>
																		<td>Sarah Smith</td>
																		<td class="center">Librarian</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std3.jpg"
																				alt="">
																		</td>
																		<td>John Deo</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std4.jpg"
																				alt="">
																		</td>
																		<td>Jay Soni</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std5.jpg"
																				alt="">
																		</td>
																		<td>Jacob Ryan</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?=base_url('assets/admin/')?>img/std/std6.jpg"
																				alt="">
																		</td>
																		<td>Megha Trivedi</td>
																		<td class="center">Librarian</td>
										...
										<div class="row">
												...
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std10.jpg" class="doctor-pic"
																alt="">
											...
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std1.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std2.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std3.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std4.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std5.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-topline-aqua">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?=base_url('assets/admin/')?>img/std/std6.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
							...
							<div class="chat-sidebar-list">
								<div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
									...
									<ul class="media-list list-items">
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof3.jpg"
										...
										<li class="media">
											...
											</div> <img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof1.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof5.jpg"
												width="35" height="35" alt="...">
											<i class="away dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof4.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof2.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof7.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											</div> <img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof6.jpg"
												width="35" height="35" alt="...">
										...
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof8.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof9.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?=base_url('assets/admin/')?>img/prof/prof10.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
	...
	<script src="<?=base_url('assets/admin/')?>plugins/popper/popper.js"></script>
	<script src="<?=base_url('assets/admin/')?>plugins/jquery-blockui/jquery.blockui.min.js"></script>
	...
	<script src="<?=base_url('assets/admin/')?>plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js"></script>
	<script src="<?=base_url('assets/admin/')?>js/pages/table/table_data.js"></script>
	<!-- Common js-->
	<script src="<?=base_url('assets/admin/')?>js/app.js"></script>
	<script src="<?=base_url('assets/admin/')?>js/layout.js"></script>
	<script src="<?=base_url('assets/admin/')?>js/theme-color.js"></script>
	<!-- Material -->
	<script src="<?=base_url('assets/admin/')?>plugins/material/material.min.js"></script>
	<!-- end js include path -->
</body>
