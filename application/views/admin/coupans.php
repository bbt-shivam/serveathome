				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Coupans</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Coupans</a>&nbsp;<i
										class="fa fa-angle-right"></i>
								</li>
								<li class="active">All Coupans</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<!-- <div class="tabbable-line"> -->
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="<?=base_url('C_admin/addCoupanPage')?>" id="addRow"
																		class="btn btn-info">
																		Add New Coupan <i class="fa fa-plus"></i>
																	</a>
																</div>
																<?=$this->session->flashdata('msgCoupan')?>
															</div>
														...
														<div class="table-scrollable">
														 	<table
																...
																<tbody>
																	<?php foreach ($coupans as $c): ?>
																		<td align="center"><?= $c['cpn_code']?></td>
																		<td align="center"><?php if($c['cpn_type']==1) echo 'Flat Discount'; else echo '% Basis';?></td>
																		<td align="center"><?php if($c['cpn_type']==1) echo '&#x20b9; '.$c['discount']; else echo $c['discount'].' %';?></td>
																		<!-- <td align="center" width="15%"><?= $c['valid_from']?></td> -->
																		<td align="center" width="15%"><?= $c['valid_till']?></td>
																		<td align="center"><?php if($c['applicable_for']==0)
																			echo "All Users"; else echo "Specific User";?><!-- <?php if($c['applicable_for']==0) echo "All users";?> --></td>
																		<td><?php  if($c['status']==1){
																			echo '<span class="clsAvailable">Active</span>';} else echo '<span class="clsNotAvailable">Inactive</span>';?> 
																		<td width="10%">
																			<a href="<?=base_url('C_admin/editCoupanPage/').$c['cpnid']?>" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<button  class="btn btn-danger btn-xs" data-toggle="modal" data-target="#dlc<?=$c['cpnid']?>">
								...
								<div class="modal fade bd-example-modal-sm"  id="dlc<?=$c['cpnid']?>" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top: 80px;">
				                    <div class="modal-dialog modal-sm">
				                        <div class="modal-content">
				                            <div class="modal-header">
				                                <h5 class="modal-title">Delete Coupan</h5>
				                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
				                                </button>
				                            </div>
				                            <div class="modal-body">Are you sure u want to delete this coupan.</div>
				                            <div class="modal-footer">
				                                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
				                                <a href="<?=base_url('C_admin/deleteCoupan/').$c['cpnid']?>" class="btn btn-primary">Yes</a>
				                            </div>
				                        </div>
				                    </div>
				                </div>
